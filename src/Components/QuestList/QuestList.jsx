        ...
        <div id='questi'>
            ...
            <ul className={s.questList}>
                <li className={s.questItem} onClick={openProkl}>
                    ...
                    <button onClick={(e) => { e.stopPropagation(); openProkl(); }} className={s.questButton}>Детальнiше</button>
                </li>
                <li className={s.questItem} onClick={openPovorot}>
                    ...
                    <button onClick={(e) => { e.stopPropagation(); openPovorot(); }} className={s.questButton}>Детальнiше</button>
                </li>
                <li className={s.questItem} onClick={openPika}>
                    ...
                    <button onClick={(e) => { e.stopPropagation(); openPika(); }} className={s.questButton}>Детальнiше</button>
                </li>
                <li className={s.questItem} onClick={openCirc}>
                    ...
                    <button onClick={(e) => { e.stopPropagation(); openCirc(); }} className={s.questButton}>Детальнiше</button>
                </li>
            </ul>
        </div>
    )
